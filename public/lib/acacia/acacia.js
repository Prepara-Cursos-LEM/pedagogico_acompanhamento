...
export const Tooltip = {
    ...
    /**
     * Exibe um menu de contexto na posição do cursor.
     *
     * @param {Array<Object>} content Lista de opções do menu.
     * @param {string} content[].Title Texto exibido no botão.
     * @param {string} content[].Ico Caminho/URL do ícone.
     * @param {Function} content[].Action Função executada ao clicar.
     * @example [
            { Title: "Editar", Ico: "/icons/edit.png", Action: () => { console.log("Editar clicado") } },
            { Title: "Excluir", Ico: "/icons/delete.png", Action: () => { console.log("Excluir clicado") } },
            { Title: "Duplicar", Ico: "/icons/copy.png", Action: () => { console.log("Duplicar clicado"); } }
        ]
     */
    Context: (content) => {
        // Creation:
...
export const Modal = {
    ...
    Window: (title, content) => {
        return new Promise(resolve => {
            ...
            contentElement.id = "modal-window-content";
