    ...
    Components: {
        ...
        UserProfilePage: (id, username, name, description, thumbnail, rank, state) => {
            Renderer.Load("profile", APPVIEW).then(x => {
                const ranks = [
                    { RankName: "Visitante", RankLevel: 0, Insignia: "/insignias/insignia.jpg" },
                    { RankName: "Cidadão", RankLevel: 1, Insignia: "/insignias/01 cidadao.jpg" },
                    { RankName: "Comerciante", RankLevel: 2, Insignia: "/insignias/02 comerciante.jpg" },
                    { RankName: "Vereador", RankLevel: 3, Insignia: "/insignias/03 vereador.jpg" },
                    { RankName: "Polícia", RankLevel: 4, Insignia: "/insignias/04 policia.jpg" },
                    { RankName: "Juiz", RankLevel: 5, Insignia: "/insignias/05 juiz.jpg" },
                    { RankName: "Deputado", RankLevel: 6, Insignia: "/insignias/06 deputado.jpg" },
                    { RankName: "Procurador", RankLevel: 7, Insignia: "/insignias/07 procurador.jpg" },
                    { RankName: "Ministro", RankLevel: 8, Insignia: "/insignias/08 ministro.jpg" },
                    { RankName: "Proibido", RankLevel: 9, Insignia: "/insignias/09 proibido.jpg" }
                ];
                // Generate Data:
                const userData = new Content.Model.Accounts.UserData();
                userData.Id = id;
                userData.Name = name;
        ...
        AccessPage: async () => {
            ...
            const newUserTab = document.getElementById("new-user-tab-item");
            const loginTab = document.getElementById("login-tab-item");
            const accessBtn = document.getElementById("access-btn");
            const registerBtn = document.getElementById("register-btn");
            newUserTab.onclick = e => {
                document.getElementById("login-tab").style.display = "none";
                document.getElementById("new-user-tab").style.display = "flex";
            ...
            loginTab.onclick = e => {
                ...
                document.getElementById("new-user-tab").style.display = "none";
                loginTab.classList.add("active");
                newUserTab.classList.remove("active");
                document.getElementById("access-btn").style.display = "flex";
                document.getElementById("register-btn").style.display = "none";
            };
            document.getElementById("login-show-passwd").addEventListener("click", () => {
                if (document.getElementById("login-passwd").getAttribute("type") == "password") {
                    document.getElementById("login-passwd").setAttribute("type", "text");
                    document.getElementById("login-show-passwd").innerText = "Ocultar senha";
                } else {
                    document.getElementById("login-passwd").setAttribute("type", "password");
                    document.getElementById("login-show-passwd").innerText = "Exibir senha";
                }
            });
            document.getElementById("register-show-passwd").addEventListener("click", () => {
                if (document.getElementById("new-user-passwd1").getAttribute("type") == "password") {
                    document.getElementById("new-user-passwd1").setAttribute("type", "text");
                    document.getElementById("new-user-passwd2").setAttribute("type", "text");
                    document.getElementById("register-show-passwd").innerText = "Ocultar senha";
                } else {
                    document.getElementById("new-user-passwd1").setAttribute("type", "password");
                    document.getElementById("new-user-passwd2").setAttribute("type", "password");
                    document.getElementById("register-show-passwd").innerText = "Exibir senha";
                }
            });
            accessBtn.onclick = () => {
                const user = new Content.Model.Accounts.UserData();
                user.Password = document.getElementById("login-passwd").value;
                user.Email = document.getElementById("login-mail").value;
                if(user.Password == "") {
                    document.getElementById("message").textContent = "Senha não informada";
                    return;
                } else if (user.Username == "") {
                    document.getElementById("message").textContent = "Email ou usuário não informado";
                    return;
                } else {
                    return user;
                }
            ...
            registerBtn.onclick = () => {
                const user = new Content.Model.Accounts.UserData();
                user.Password = document.getElementById("new-user-passwd1").value;
                user.Email = document.getElementById("new-user-email").value;
                user.Name = document.getElementById("new-user-name").value;
                if (user.Password == "") {
                    document.getElementById("message").textContent = "Senha não informada";
                    return;
                } else if (user.Password != document.getElementById("new-user-passwd2").value) {
                    document.getElementById("message").textContent = "Senhas não conferem";
                    return;
                } else if (user.Email == "") {
                    document.getElementById("message").textContent = "E-mail não informado";
                    return;
                } else if (user.Name == "") {
                    document.getElementById("message").textContent = "Nome não informado";
                    return;
                } else {
                    return user;
                }
