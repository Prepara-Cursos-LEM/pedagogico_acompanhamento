export const Content = {
    ...
    Model: {
        Application: class {
            ...
            "LoginState";
            "Authorization";
            constructor(applicationKey, applicationId, applicationName, lastAccess, createdAt, loginState, authorization) {
        ...
        HttpMessage: class {
            ...
            "ApplicationId";
            "Payload";
            constructor(applicationKey, applicationId, payload) {
                this["ApplicationKey"] = applicationKey;
                this["ApplicationId"] = applicationId;
        ...
        WebSocketMessage: class {
            ...
            "ConnectionId";
            "Payload";
            constructor(applicationKey, applicationId, connectionId, payload) {
                this["ApplicationKey"] = applicationKey;
                this["ApplicationId"] = applicationId;
        ...
        MessagePayload: class {
            ...
            "Timestamp";
            "Content";
            constructor(type, token, userId, timestamp, content) {
                this["Type"] = type;
                this["Token"] = token;
                this["UserId"] = userId;
        ...
        Learn: {
            Class: class {
                ...
                "Link";
                "Comments";
                constructor(id, title, description, thumbnail, upVotes, link, comments) {
                    this["Id"] = id;
                    this["Title"] = title;
            ...
            Path: class {
                ...
                "Category";
                "Courses";
                constructor(id, title, subtitle, description, cover, duration, category, courses) {
                    this["Id"] = id;
                    this["Title"] = title;
            ...
            Course: class {
                ...
                "Classes";
                "Students";
                constructor(id, title, subtitle, description, duration, cover, bookCover, category, preview, eBook, kindle, downloads, classes, students) {
                    this["Id"] = id;
                    this["Title"] = title;
                    this["Subtitle"] = subtitle;
                    this["Description"] = description;
        ...
        Finance: {
            Transaction: class {
                ...
                "Amount";
                "Time";
                constructor(id, type, title, description, amount, time) {
                    this["Id"] = id;
                    this["Type"] = type;
                    this["Title"] = title;
                    this["Description"] = description;
        ...
        Chat: {
            Message: class {
                ...
                "Upvotes";
                "Self";
                constructor(messageId, time, username, name, receivers, thumbnail, type, content, upvotes, self) {
            ...
            Post: class {
                ...
                "Upvotes";
                "Comments";
                constructor(postId, time, username, name, thumbnail, type, content, upvotes, comments) {
                    this["PostId"] = postId;
                    this["Time"] = time;
                    this["Username"] = username;
                    this["Name"] = name;
            ...
            Comment: class {
                ...
                "Upvotes";
                "Thumbnail";
                constructor(commentId, time, username, name, content, upvotes, thumbnail) {
        ...
        Accounts: {
            Token: class {
                ...
                "CreatedAt";
                "ExpiresAt";
                constructor(id, username, secret, createdAt, expiresAt) {
                    this["Id"] = id;
                    this["Username"] = username;
                    this["Secret"] = secret;
                    this["CreatedAt"] = createdAt;
            ...
            Credential: class {
                ...
                "Logged";
                "Token";
                constructor(id, username, email, password, logged, token) {
                    this["Id"] = id;
                    this["Username"] = username;
                    this["Email"] = email;
            ...
            User: class {
                ...
                "Description";
                "Thumbnail";
                constructor(id, username, name, description, thumbnail) {
                    this["Id"] = id;
                    this["Username"] = username;
                    this["Name"] = name;
                    this["Description"] = description;
            ...
            UserData: class {
                ...
                "RegisterTime";
                "LastAccessTime";
                constructor(id, username, name, description, profilePicture, genre, email, mailVerified, userVerified, level, daysStreak, registerTime, lastAccessTime) {
                    this["Id"] = id;
                    this["Username"] = username;
                    this["Name"] = name;
                    this["Description"] = description;
            ...
            RoomData: class {
                ...
                "BlockedList";
                "Users";
                constructor(id, username, name, description, profilePicture, email, registerTime, blockedList, users) {
                    this["Id"] = id;
                    this["Username"] = username;
                    this["Name"] = name;
                    this["Description"] = description;
            ...
            UserState: class {
                ...
                "DocumentId";
                "PhoneNumber";
                constructor(id, points, stars, level, xp, coins, gems, documentId, phoneNumber) {
                    this["Id"] = id;
                    this["Points"] = points;
                    this["Stars"] = stars;
                    this["Level"] = level;
